...
Benvenuto nel repository ufficiale di **DineCraft**, un progetto web interamente dedicato a un'esperienza gastronomica leggendaria a tema Minecraft, dove i mondi dell'Overworld, del Nether e dell'End si incontrano nel piatto.

Il progetto è stato sviluppato per il corso universitario di **Comunicazione Visiva e Design delle Interfacce** presso **UniMiB**, Anno Accademico 2025/2026.
...
3.  **Menù (`menu.html`)**: Diviso rigorosamente nelle tre dimensioni di gioco, con la possibilità di essere letto in tre lingue diverse (italiano, inglese e galactic) e include un sistema che permette agli utenti di nascondere o mostrare i piatti in base alle proprie esigenze o intolleranze alimentari.
...
1. Clonare il repository:
   ```bash
   git clone [https://github.com/stefanomandelli/UX-Factor-Minecraft.git](https://github.com/stefanomandelli/UX-Factor-Minecraft.git)```
